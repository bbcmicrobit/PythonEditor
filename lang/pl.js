var LANGUAGE = {
  "code_snippets": {
    ...
    "description": "Fragmenty kodu są krótkimi blokami kodu do używania we własnych programach. Są to fragmenty najbardziej spotykanych rzeczy, które będziemy chcieli zrobić użwając MicroPython.",
    ...
    "wh": "podczas gdy jakiś warunek jest prawdziwy, zachowaj pętle kodu",
    "with": "zrób coś z czymś przypisanym do nazwy",
    "cl": "utwórz nową klasę, która definiuje zachowanie nowego typu obiektu",
    "def": "zdefiniuj nazwaną funkcję, która przyjmuje pewne argumenty i opcjonalnie dodaj opis",
  ...
  "webusb": {
    ...
    "close": "Zamknij",
    "request-repl": "Wyślij CTRL-C aby uruchomić REPL",
  ...
  "load": {
    ...
    "file-help-text": "Obszar Pliki projektu pokazuje pliki zawarte w twoim programie i pozwala dodawać lub usuwać zewnętrzne moduły Pythona i inne pliki. Dowiedz się więcej w ",
